...
export type WechatUploadImage = {
  data: Uint8Array;
  ext: Exclude<SupportedImageExtension, 'webp'>;
};
export type NormalizeWechatUploadImage = (
  data: Uint8Array,
...
export function hasWebpSignature(data: Uint8Array): boolean {
...
export function createProcessContentImages(normalizeWechatUploadImage: NormalizeWechatUploadImage) {
  return async function processContentImages(html: string, token: string): Promise<{
    html: string;
