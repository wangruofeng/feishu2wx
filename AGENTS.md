...
本文件只保留 Codex 在本仓库中工作时必须知道的最小上下文。详细说明请查看拆分后的文档。
...
- 架构与渲染细节：[docs/Codex/architecture.md](docs/Codex/architecture.md)
- 开发命令、测试、部署与提交流程：[docs/Codex/development.md](docs/Codex/development.md)
